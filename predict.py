...
pipeline = model.FastFlowYOLOPipeline(
    'weights/yolov7.pt', 'weights/fastflownet_gtav.pth', 'inference/__ini_yg_paling_baru_confidence_score/1700_bst/',
    False, binary_tresh=200, binary_sum_tresh=1700, is_opening=True)

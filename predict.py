...
pipeline = model.FastFlowYOLOPipeline(
    'weights/yolov7.pt', 'weights/fastflownet_gtav.pth', 'inference/pred_with_confidance_score_300_opening/',
    False, binary_tresh=200, binary_sum_tresh=300, is_opening=True)
